...
export class MathError extends HajaRuntimeError {
...
export class IndexOutOfBoundsError extends HajaRuntimeError {
  constructor(msg: string, line: number) {
    super(msg, line);
...
export class KeyError extends HajaRuntimeError {
  constructor(msg: string, line: number) {
    super(msg, line);
    this.name = 'KeyError';
  }
...
export class ConversionError extends HajaRuntimeError {
  constructor(msg: string, line: number) {
    super(msg, line);
...
export class ImmutableAssignmentError extends HajaRuntimeError {
  constructor(msg: string, line: number) {
    super(msg, line);
